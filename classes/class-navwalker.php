...
if ( !class_exists( 'Navwalker_Class' ) ) {
    ...
    class Navwalker_Class extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
             ...
             * @param int      $depth   Depth of menu item. Used for padding.
             */
            $id = apply_filters( 'nav_menu_item_id', 'testtttttttttttt menu-item-' . $item->ID, $item, $args, $depth );
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                $fallback_output .= '>';
                $fallback_output .= '<li><a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr__( 'Home', 'telnet' ) . '">' . esc_html__( 'Home', 'telnet' ) . '</a></li>';
                $fallback_output .= '</ul>';
                if ( $container ) {
                    $fallback_output .= '</' . esc_attr( $container ) . '>';
                }
