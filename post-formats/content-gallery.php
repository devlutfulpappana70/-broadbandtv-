 ...
 */
    ...
    $id = get_the_ID();
    $post_gallery_metabox = get_post_meta($id, 'telnet_post_gallery_meta', true) ? get_post_meta($id, 'telnet_post_gallery_meta', true) : [];
...
?>
    ...
    <?php if ( !empty( $gallery_images ) ): ?>
        <div class="tx-blog-box__tx-thumb tx-thumb-zoom mb-30 position-relative">
    ...
    <article id="post-<?php the_ID(); ?>"  <?php post_class( 'tx-blog-box tx-radious-25 tx-border-all tx-border-op-10 mt-30 format-gallery'); ?>>

        <?php if ( !empty( $gallery_images ) ): ?>
        <div class="tx-blog-box__tx-thumb tx-thumb-zoom tx-pd-30 pb-0 position-relative pt-0 mt-30">
            <div class="swiper-container" data-txPostGallery>
                <div class="swiper-wrapper">
                    <?php foreach ( $gallery_ids as $gallery_item_id  ): ?>
                    <div class="swiper-slide">
