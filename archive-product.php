...
$telnet_woo_col = "col-xl-12";
if (is_active_sidebar('product-sidebar')) {
    $telnet_woo_col = "col-xl-8";
}
?>

<div class="row wrapper tx-column-gap-30">
    <div class="<?php print esc_attr($telnet_woo_col); ?>">
                    ...
                    <div class="tab-pane fade show mt-none-20 active" id="shop-tab-1" role="tabpanel" aria-labelledby="shop-tab-1-tab">
                        ...
                        if (wc_get_loop_prop('total')) {
                            while (have_posts()) {
                                ...
                                $telnet_product_col = "col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-20";
                                if (is_active_sidebar('product-sidebar')) {
                                    $telnet_product_col = "col-lg-4 col-md-6 col-sm-6 mt-20";
                                }

                                print '<div class="'.esc_attr($telnet_product_col).'">';
                                /**
                    ...
                    <div class="tab-pane fade show mt-none-30" id="shop-tab-2" role="tabpanel" aria-labelledby="shop-tab-2-tab">
                        ...
                        if (wc_get_loop_prop('total')) {
                            while (have_posts()) {
                                ...
                                print '<div class="col-xl-12 mt-40">';
                                /**
                                 * Hook: woocommerce_shop_loop.
                                 *
                                 * @hooked WC_Structured_Data::generate_product_data() - 10
